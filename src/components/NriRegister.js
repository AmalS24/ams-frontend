      ...
      <div className="w-97 lg:flex lg:w-150 h-98 mx-auto mt-4 bg-white shadow-2xl">
        <div className="bg-gray-400 lg:flex flex-col lg:w-3/5 items-center justify-center h-full hidden">
          ...
          >
            ...
            <path
              ...
              fill="#ccc"
            />
            <circle cx="325.02994" cy="26.9685" r="26.96851" fill="#00bfa6" />
            <path
            ...
            <path
              ...
              fill="#ccc"
            />
            <circle cx="222.02994" cy="143.9685" r="26.96851" fill="#00bfa6" />
            <path
            ...
            <path
              ...
              fill="#ccc"
            />
            <circle cx="441.70332" cy="226.5592" r="34.13884" fill="#00bfa6" />
            <path
          ...
          <h1 className="text-3xl mt-10 font-semibold tracking-normal uppercase">
            Verification
          </h1>
        </div>
        <div className="bg-white flex flex-col items-center w-full h-full ">
          ...
          >
            <label
              htmlFor="email"
              className="text-2xl mt-4 ml-4 font-light tracking-tighter"
            >
              Email
            </label>
            <div className="flex items-center max-w-full mt-1 flex-row">
              <input
                type="email"
                id="email"
            ...
            <div className="lg:mt-4 lg:flex flex-row ">
              <div className=" mt-8">
                <label
                  htmlFor="name"
                  className="text-2xl  ml-4 lg:mt-14 font-light tracking-tighter"
                >
                  Name
                </label>
              ...
              <div className=" lg:mt-8 mt-6">
                <label
                  htmlFor="phone"
                  className="text-2xl  ml-4  font-light tracking-tighter"
                >
                  Phone
                </label>
                <div className="flex items-center mt-2  flex-row">
