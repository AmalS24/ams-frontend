  ...
  return (
    <div className="w-full bg-trout-500 h-screen">
      <div className="  w-full flex items-center justify-between xs:px-10 px-20 py-8 h-14">
        ...
        <ProgressBar progressPercentage="76" />
            ...
            <div className="flex flex-row items-center justify-between px-10 py-2">
              ...
              <div>
                <button>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-12 w-12 cursor-not-allowed opacity-50 bi bi-house-fill transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110"
                    fill="red"
                    viewBox="0 0 24 24"
                    stroke="white"
                  >
