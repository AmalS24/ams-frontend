...
function NriLogin() {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    setLoading(true);
    console.warn(applicationNo, password,loading);
            ...
            <div className="lg:w-97 flex  h-auto mx-auto shadow-3xl">
              ...
              >
                ...
                <div className="w-full h-full py-8 bg-white">
                  <label
                    htmlFor="username"
                    className="ml-6 font-light text-2xl"
                  >
                    Username
                  </label>
                  <input
                  ...
                  />
                  <button className="flex items-center mt-8 ml-6 justify-center w-30 shadow-2xl rounded-full h-14 border-2 border-red-600 text-red-600 text-2xl hover:text-white hover:bg-red-600">
                    Sign-In
                  </button>
