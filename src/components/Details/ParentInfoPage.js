...
function ParentInfoPage() {
  return (
    <div className="w-screen h-full bg-transparent ">
      <form
        action=""
        className="w-200 flex flex-col items-center py-3 space-y-2 justify-start mx-auto mt-4 left-10 h-99 rounded-sm bg-white"
      >
        ...
        <div className="w-11/12 flex flex-col mx-auto h-80">
          <div className="w-full grid grid-cols-3 h-4/5 ">
            ...
            <div className="h-full flex  space-y-8  flex-col">
              <h1 className="text-xl font-bold ml-6 underline  animate-pulse">Current Status</h1>
              <div className="w-80 mx-auto h-40 flex items-center justify-center  rounded-xl border-2 border-black">
              <p className="text-xl text-center text-torch-red-500 italic">We've received your request await for confirmation</p>
              </div>
            </div>
          </div>
        </div>
