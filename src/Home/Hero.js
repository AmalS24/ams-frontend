...
const Hero = () => {
  return (
    <div className="flex w-full relative bg-gray-200 overflow-hidden h-98.5">
      ...
      <div
        data-aos="zoom-in" 
        className="w-99.5 ml-10 mt-12 tracking-tighter text-left shadow-xl space-y-6 px-36 py-10  h-97.75 bg-white"
      >
        ...
        <p className="mx-24 text-5xl">• Register</p>
        <p className="mx-24 text-5xl">• Login</p>
        <p className="mx-24 text-5xl">• Details</p>
        <p className="mx-24 text-5xl">• Payment</p>
      </div>
    </div>
  );
};
